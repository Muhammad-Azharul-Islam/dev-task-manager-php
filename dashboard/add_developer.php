...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(empty($username) || empty($password) || empty($email) || empty($confirm_password)) {
        ...
        if($user->create($username, $password, $email, 'developer')) {
            $success = 'Developer account created successfully!';
        } else {
            $error = 'Failed to create developer account. Username or email might already exist.';
        }
    }
}
?>
...
<head>
    ...
    <title>Add Developer - Lemon Hive</title>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Add New Developer</h3>
                        <p class="mt-1 text-sm text-gray-600">
                            Create a new developer account. The developer will be able to log in with these credentials.
                        </p>
                    </div>
                </div>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <a href="index.php" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 mr-3">
                                    Cancel
                                </a>
